...
public class ${jaxrs_service_interface}ImplTest {
    ...
    @Test
    public void openApiSchemaEndpointTest() {
        LOGGER.info("Start ${jaxrs_service_interface}ImplTest openApiSchemaEndpointTest");
    ...
    @Test
    public void swaggerUiEndpointTest() {
        LOGGER.info("Start ${jaxrs_service_interface}ImplTest swaggerUiEndpointTest");
    ...
    public void defaultEndpointTest() {
        LOGGER.info("Start ${jaxrs_service_interface}ImplTest defaultEndpointTest");
